...
- [`LoadSM()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/LoadSM.md)
  : Loads spatial metabolic data into a SpaMTP Seurat Object
- [`ReadSM_mtx()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/ReadSM_mtx.md)
  : Read Spatial Metabolomics matrix file (.csv format)
- [`Load_METASPACE()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/Load_METASPACE.md)
...
- [`CardinalToSeurat()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/CardinalToSeurat.md)
  : Converts a Cardinal Object into a SpaMTP Seurat Object
- [`ConvertSeuratToCardinal()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/ConvertSeuratToCardinal.md)
...
- [`BinSpaMTP()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/BinSpaMTP.md)
  : Bin SpaMTP Object
...
- [`AnnotationInfo()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/AnnotationInfo.md)
  ...
  object
- [`print(`*`<spamtp_mz_index>`*`)`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/print.spamtp_mz_index.md)
...
- [`SearchAnnotations()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/SearchAnnotations.md)
  : Find Annotation
- [`GetMZMetadata()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/GetMZMetadata.md)
  : Gets values from a single metadata column for a respective m/z
  value.
- [`FindDuplicateAnnotations()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/FindDuplicateAnnotations.md)
  : Finds if any metabolite is duplicated across multiple m/z values.
- [`SubsetMZFeatures()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/SubsetMZFeatures.md)
  : Subset a SpaMTP Seurat Spatial Metabolomic object by a list of m/z's
- [`AnnotateBigData()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/AnnotateBigData.md)
  : Annotates vector of m/z values
- [`getRefinedAnnotations()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/getRefinedAnnotations.md)
...
- [`CalculateAnnotationStatistics()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/CalculateAnnotationStatistics.md)
...
- [`CalculateSingleAnnotationStatistics()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/CalculateSingleAnnotationStatistics.md)
...
- [`Pseudo_msms()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/Pseudo_msms.md)
  : Find all library spectra10 above a cosine threshold for each imaging
  peak, restricting to a global precursor-mz range.
- [`CreatePathwayObject()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/CreatePathwayObject.md)
...
- [`RefineLipids()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/RefineLipids.md)
...
- [`DEMsHeatmap()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/DEMsHeatmap.md)
...
- [`RunRAMPgeseca()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/RunRAMPgeseca.md)
...
- [`CreatePathwayAssay()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/CreatePathwayAssay.md)
...
- [`VisualisePathways()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/VisualisePathways.md)
  : Visualise Significant Pathways
- [`PlotRegionalPathways()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/PlotRegionalPathways.md)
  : Plot significantly enriched pathways per region
- [`PlotPathways()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/PlotPathways.md)
  ...
  reduction technique.
- [`PlotPathwaysSpatially()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/PlotPathwaysSpatially.md)
...
- [`PathwayNetworkPlots()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/PathwayNetworkPlots.md)
...
- [`RunMetabolicPCA()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/RunMetabolicPCA.md)
...
- [`RunSpatialGraphPCA()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/RunSpatialGraphPCA.md)
  ...
  Spatial Data
- [`GetKmeanClusters()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/GetKmeanClusters.md)
...
- [`ImageMZPlot()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/ImageMZPlot.md)
  : Plot expression of m/z values spatially
- [`ImageMZAnnotationPlot()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/ImageMZAnnotationPlot.md)
  : Plot expression of annotated metabolites spatially
- [`SpatialMZPlot()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/SpatialMZPlot.md)
  : Plot expression of m/z values spatially for a Spatial SpaMTP Seurat
  Objects.
- [`SpatialMZAnnotationPlot()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/SpatialMZAnnotationPlot.md)
  : Plot expression of metabolites in spatially from a Spatial SpaMTP
  Objects.
- [`Plot3DFeature()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/Plot3DFeature.md)
  : Generates a 3D spatial feature plot from a SpaMTP object
- [`MassIntensityPlot()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/MassIntensityPlot.md)
  : Plot mass intensity spectra
- [`DensityMap()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/DensityMap.md)
  : Generates interactive 3D spatial density plot for m/z values
- [`CheckAlignment()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/CheckAlignment.md)
...
- [`InteractiveSpatialPlot()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/InteractiveSpatialPlot.md)
...
- [`FindNearestMZ()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/FindNearestMZ.md)
  : Finds the nearest m/z peak to a given value in a SpaMTP Object
- [`BinMetabolites()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/BinMetabolites.md)
...
- [`FindCorrelatedFeatures()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/FindCorrelatedFeatures.md)
  : Find top features and metabolites that are strongly correlated with
  a given feature
- [`FindSpatiallyVariableMetabolites()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/FindSpatiallyVariableMetabolites.md)
  : Find Spatially Variable Metabolites
- [`GetSpatiallyVariableMetabolites()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/GetSpatiallyVariableMetabolites.md)
  : Get top spatially variable metabolites
- [`RowVar()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/RowVar.md)
...
- [`CreateMergedModalityAssay()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/CreateMergedModalityAssay.md)
...
- [`AddSMImage()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/AddSMImage.md)
...
- [`SelectROIs()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/SelectROIs.md)
...
- [`TMMNormalize()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/TMMNormalize.md)
  : Performs TMM normalization between categories based on a specified
  ident
- [`MZRidgePlot()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/MZRidgePlot.md)
  : Generates a ridge plot of spatial metabolic intensity data
- [`MZVlnPlot()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/MZVlnPlot.md)
  : Generates a violin plot of spatial metabolic intensity data
- [`MZBoxPlot()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/MZBoxPlot.md)
...
- [`add_ssc_annotation()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/add_ssc_annotation.md)
...
- [`BinnedCardinalToSeurat()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/BinnedCardinalToSeurat.md)
  : Converts a SpaMTP binned Cardinal Object into a SpaMTP Seurat Object
- [`spectral_binning()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/spectral_binning.md)
...
- [`bin.mz()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/bin.mz.md)
  : Bins multiple m/z values into one.
- [`plusminus()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/plusminus.md)
  : Identifies all mz peaks within a plus-minus range of the target_mz
- [`plot_plus_minus()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/plot_plus_minus.md)
  : Helper Function to generate merged counts within the plus minus
  range provided
- [`check_column_type()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/check_column_type.md)
  : Helper function to determine if a column contains categorical or
  continuous Data
- [`pixelPlot()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/pixelPlot.md)
...
- [`metaspace_client()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/metaspace_client.md)
  : Metaspace R Client Constructor
- [`get_metaspace()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/get_metaspace.md)
  : Core METASPACE Data Retrieval
- [`metaspace_to_feature_matrix()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/metaspace_to_feature_matrix.md)
...
- [`run_pooling()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/run_pooling.md)
  : Pools SpaMTP Seurat object into random pools for pseudo-bulking.
- [`run_DE()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/run_DE.md)
  : Runs EdgeR analysis for pooled data
- [`save_pheatmap_as_pdf()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/save_pheatmap_as_pdf.md)
...
- [`PlotSinglePathway()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/PlotSinglePathway.md)
  : Plots the expression profile of a feature set corresponding to
  specified pathways onto a 2D scatter plot based on a dimensionality
  reduction technique.
- [`PlotSinglePathwaySpatially()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/PlotSinglePathwaySpatially.md)
  : Plot expression profile of a single RAMP pathway spatially
- [`addGesecaScores()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/addGesecaScores.md)
  : Add GESECA Scores to SpaMTP Object
- [`get_analytes_db()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/get_analytes_db.md)
  : Helper function for building a pathway db based on detected
- [`list_to_pprcomp()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/list_to_pprcomp.md)
...
- [`kneighbors_graph()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/kneighbors_graph.md)
  : Construct a k-Nearest Neighbour Graph from Spatial Coordinates.
- [`get_square_coordinates()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/get_square_coordinates.md)
  : This function computes the coordinates of a square's four corners
  based on a given center point and width.
- [`lowresMapping()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/lowresMapping.md)
...
- [`statPlot()`](https://genomicsmachinelearning.github.io/SpaMTP/developmental/reference/statPlot.md)
