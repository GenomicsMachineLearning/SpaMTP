...
NOTE: This is a helper function for `PlotPathwaysSpatially`. This
function has been adapted from fgsea package. For more detail about
...
- pathway:
  ...
  Character vector of analyte IDs (genes or metabolites) in the pathway.
