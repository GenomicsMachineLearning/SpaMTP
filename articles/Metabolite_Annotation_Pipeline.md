...
[`Annotation Refinement`](https://genomicsmachinelearning.github.io/SpaMTP/articles/Annotation_Refinement.md)
...
| ramp_version   | 3.0.7                      |
| generated_at   | 2026-09-19 03:25:28 UTC    |
| candidates     | 4                          |
| assay          | SPM                        |
...
```
    ...
    ##  [37] shiny_1.14.0           digest_0.6.39          S4Vectors_0.50.2       patchwork_1.3.2       
