...
```{r fig.width=7, fig.height=7, warning=FALSE, message=FALSE, dpi=72}
...
<iframe src="vignettes/vignette_data_files/Mouse_Urinary_Bladder/3d_plot1.html" width="100%" height="600px"></iframe>
