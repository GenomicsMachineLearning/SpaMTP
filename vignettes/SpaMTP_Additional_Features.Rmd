...
Plot3DFeature(ROI_HE, features = mzs, show.image = "slice1", assays = "Spatial", between.layer.height = 200, names = c("PC(34:1)","SM(34:1)"), plot.height = 400, plot.width = 800, downscale.image = 3)
