...
```{r, include=FALSE}
bladder_he_file <- resolve_spamtp_vignette_file(
  article = "SpaMTP_Additional_Features",
  filename = "bladder_HE.RDS",
  url = "https://zenodo.org/api/records/17246684/files/bladder_HE.RDS/content",
  expected_md5 = "12748584aff1e9a768577536dd0a678e"
)
bladder_HE <- readRDS(bladder_he_file)
