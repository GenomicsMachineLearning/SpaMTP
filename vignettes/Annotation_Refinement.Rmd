...
spotted_path <- "vignette_data_files/Annotation_Refinement/spotted_Annotated_H_Cl_Adducts.RDS"
...
output_url <- "https://zenodo.org/records/17352749/files/annotation_zscore_output.RDS?download=1"
output_path <- "vignette_data_files/Annotation_Refinement/annotation_zscore_output.RDS"
if (!file.exists(output_path)) {
  dir.create(dirname(output_path), recursive = TRUE, showWarnings = FALSE)
  tryCatch(
    download.file(output_url, output_path, mode = "wb", quiet = TRUE, method = "libcurl"),
    error = function(e) message("Download failed: ", conditionMessage(e))
  )
}
