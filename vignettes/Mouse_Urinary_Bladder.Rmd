...
```{r, eval = FALSE, fig.width=10, fig.height=10, dev.args=list(bg="#ffffff"), warning=FALSE, message=FALSE}
image(pig206_peaks, mz=537.08)
title("Cardinal", outer = TRUE)
```


```{r, eval = FALSE,fig.width=8, fig.height=5,, dev.args=list(bg="#ffffff"), warning=FALSE, message=FALSE}
