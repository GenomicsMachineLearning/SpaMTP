...
The first pathway analysis method uses principle component analysis (PCA) to determine metabolites that explain the most variance between each PCA. These metabolites are then checked against a reference pathway database to identify up- and down-regulated pathways for each PCA.
