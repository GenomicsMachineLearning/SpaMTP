...
if (!file.exists(pig206_path)) {
  ...
  download.file(pig206_url, pig206_path, mode = "wb", quiet = TRUE)
}
...
if (!file.exists(rcc_path)) {
  ...
  download.file(rcc_url, rcc_path, mode = "wb", quiet = TRUE)
}
...
if (!file.exists(metadata_path)) {
  ...
  download.file(metadata_url, metadata_path, mode = "wb", quiet = TRUE)
}
...
if (!file.exists(raw_bladder_path)) {
  ...
  download.file(raw_bladder_url, raw_bladder_path, mode = "wb", quiet = TRUE)
}
