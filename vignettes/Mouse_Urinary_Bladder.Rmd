...
```{r, warning=FALSE, message=FALSE, results='hide'}
cluster_6_pathways <- FishersPathwayAnalysis(list("metabolites" = unique(unlist(strsplit(cluster_6$annotations, "; ")))),
...
```{r, eval=FALSE}
x <- FindRegionalPathways(SpaMTP = bladder_x,
                                ident = "ssc",
...
```{r echo=FALSE, results='hide',warning=FALSE, message=FALSE, fig.width=10, fig.height=30}
p <- PathwaysPerRegion(bladder_annotated,ident = "ssc", polarity = "positive", assay = "Spatial",slot = "counts")
```
