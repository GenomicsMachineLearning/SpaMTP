...
metabolite_ids <- ROI[["Spatial"]]@meta.data[ROI[["Spatial"]]@meta.data$all_IsomerNames %in% cluster_6$annotations,]$all_Isomers


tester <- FishersPathwayAnalysis(list("mzs" = cluster_6$gene),
                            max_path_size = 500,
                            alternative = "greater",
                            min_path_size = 5,
                            pathway_all_info = T,
...
```{r, warning=FALSE, message=FALSE, results='hide'}
cluster_6_pathways <- FishersPathwayAnalysis(list("mzs" = cluster_6$gene),
                            max_path_size = 500,
                            alternative = "greater",
                            min_path_size = 5,
                            pathway_all_info = T,
...
Lets now visualise these results
...
```{r, eval=FALSE}
x <- FindRegionalPathways(SpaMTP = ROI,
                                ident = "ssc",
...
This function produces a data.frame of differentially expressed pathways. Lets now plot the results:

```{r echo=FALSE, results='hide',warning=FALSE, message=FALSE, fig.width=10, fig.height=30}
p <- PathwaysPerRegion(ROI,ident = "ssc", polarity = "positive", assay = "Spatial",slot = "counts")
```
