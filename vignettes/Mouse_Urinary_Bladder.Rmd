...
```{r fig.width=7, fig.height=4, dpi = 96, dev.args = list(bg = "#ffffff")}
...
```{r, eval = FALSE, fig.width=7, fig.height=4, dpi = 96, dev.args=list(bg="#ffffff"), warning=FALSE, message=FALSE}
image(pig206_peaks, mz=537.08)
...
```{r, include=FALSE}
options(timeout = 600)
url <- "https://zenodo.org/records/17246588/files/rcc.RDS?download=1"
#download.file(url, destfile = "rcc.RDS", mode = "wb")
rcc_spamtp <- readRDS(url(url))
```
...
```{r, fig.width=7, fig.height=4, dpi = 96, warning=FALSE, message=FALSE}
...
```{r fig.width=20, fig.height=3, dpi = 96, warning=FALSE, message=FALSE}
...
```{r, fig.width=20, fig.height=5, dpi = 96, warning=FALSE, message=FALSE}
...
```{r, fig.width=15, fig.height=10, dpi=96, dev.args = list(bg = "#ffffff")}
...
```{r, fig.width=33, fig.height=10, dpi=96, warning=FALSE, message=FALSE}
...
```{r, fig.width=10, fig.height=10, dpi=96}
volc_plot
```
...
```{r, fig.width=7, fig.height=5, dpi=96,warning=FALSE, message=FALSE}
...
```{r, fig.width=15, fig.height=5,dpi=96, warning=FALSE, message=FALSE}
# Compute counts of Lipid Maps Categories for 'Up' and 'Down' entries
category_counts <- UP %>%
...
```{r, fig.width = 10, fig.height = 5,dpi=96, warning=FALSE, message=FALSE}
...
```{r echo=FALSE, results='hide',warning=FALSE, message=FALSE, fig.width=10, fig.height=30,dpi=96, dev.args = list(bg = "#ffffff")}
p <- VisualisePathways(ROI,pathway_df = cluster_6_pathways,p_val_threshold = 0.1,assay = "Spatial",slot = "counts", verbose = F)
```

```{r echo=FALSE, results='asis',warning=FALSE, message=FALSE, fig.width=30, fig.height=10,dpi=96, dev.args = list(bg = "#ffffff")}
p
```
...
```{r echo=FALSE, results='hide',warning=FALSE, message=FALSE, dpi=96,fig.width=10, fig.height=30, dev.args = list(bg = "#ffffff")}
...
```{r echo=FALSE, results='asis',warning=FALSE, message=FALSE, dpi=96,fig.width=30, fig.height=10, dev.args = list(bg = "#ffffff")}
p
```
...
```{r warning=FALSE, message=FALSE,dpi=96, fig.width=30, fig.height=8}
...
```{r, warning=FALSE, message=FALSE, fig.width=8, dpi=96,fig.height=5}
...
```{r warning=FALSE, message=FALSE, fig.width=30,dpi=96, fig.height=10}
## Formats Plots 
plots <- list()
...
```{r fig.width=30, fig.height=10, dpi=96,warning=FALSE, message=FALSE}
...
```{r, fig.width=8, fig.height=5 ,dpi=96, dev.args = list(bg = "#ffffff")}
...
```{r warning=FALSE, message=FALSE,dpi=96, fig.width=15, fig.height=10}
