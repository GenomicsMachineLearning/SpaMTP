...
if (!file.exists(pig206_path)) {
  ...
  tryCatch(
    download.file(pig206_url, pig206_path, mode = "wb", quiet = TRUE, method = "libcurl"),
...
if (!file.exists(rcc_path)) {
  ...
  tryCatch(
    download.file(rcc_url, rcc_path, mode = "wb", quiet = TRUE, method = "libcurl"),
    error = function(e) message("Download failed: ", conditionMessage(e))
  )
}
...
if (!file.exists(metadata_path)) {
  ...
  tryCatch(
    download.file(metadata_url, metadata_path, mode = "wb", quiet = TRUE, method = "libcurl"),
    error = function(e) message("Download failed: ", conditionMessage(e))
  )
}
...
if (!file.exists(raw_bladder_path)) {
  ...
  tryCatch(
    download.file(raw_bladder_url, raw_bladder_path, mode = "wb", quiet = TRUE, method = "libcurl"),
    error = function(e) message("Download failed: ", conditionMessage(e))
  )
}
...
<details>
  <summary>*Code used to generate the cirlce plot in the SpaMTP publication (Fig2E)*</summary>
