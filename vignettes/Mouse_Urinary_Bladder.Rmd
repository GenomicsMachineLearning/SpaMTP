...
We can also plots some key pathways of interest that were also up regulated in our dataset.
```{r warning=FALSE, message=FALSE,  fig.width=15, fig.height=10}
...
Based on these findings we observe that the lamina propria (cluster 5) has an up regulation of metabolites associated with sensory perception pathways. This matches the biology as this is the layer of the bladder that contains the sensory neurons.   
