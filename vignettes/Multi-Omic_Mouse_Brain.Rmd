...
combined.data <- MapSpatialOmics(SM.data = msi_transformed, ST.data = vis, overlap.threshold = 0.2, annotations = TRUE, ST.scale.factor = NULL)
```
...
results <- cluster_DEMs$DEMs[cluster_DEMs$DEMs$cluster == "1",]
