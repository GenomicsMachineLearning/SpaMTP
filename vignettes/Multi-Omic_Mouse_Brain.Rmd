...
if (!file.exists(vis_path)) {
  ...
  download.file(vis_url, vis_path, mode = "wb", quiet = TRUE)
}
...
if (!file.exists(fmp10_path)) {
  ...
  download.file(fmp10_url, fmp10_path, mode = "wb", quiet = TRUE)
}
...
if (!file.exists(msi_path)) {
  ...
  download.file(msi_url, msi_path, mode = "wb", quiet = TRUE)
}
...
if (!file.exists(striatum_path)) {
  ...
  download.file(striatum_url, striatum_path, mode = "wb", quiet = TRUE)
}
