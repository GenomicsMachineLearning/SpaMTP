...
if (!file.exists(spotted_path)) {
  ...
  download.file(spotted_url, spotted_path, mode = "wb", quiet = TRUE)
}
spotted_small <- readRDS(spotted_path)
```
...
if (inherits(spotted_small, "Seurat")) {
  spotted_small <- SeuratObject::UpdateSeuratObject(spotted_small, verbose = FALSE)
}
