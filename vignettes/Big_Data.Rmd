...
<div style="margin-left: auto;
            margin-right: auto">
```{r, echo=FALSE}
results_file <- resolve_spamtp_vignette_file(
  article = "Big_Data",
  filename = "results_spotted.csv",
  url = "https://zenodo.org/api/records/17352749/files/results_spotted.csv/content",
  expected_md5 = "d4baf47c9c35e9ce50ff3e88782cf8b0"
)
df <- read.csv(results_file, row.names = 1)
df %>%
...
```{r, include=FALSE}
spotted_small_file <- resolve_spamtp_vignette_file(
  article = "Big_Data",
  filename = "spotted_small_ROI.RDS",
  url = "https://zenodo.org/api/records/17352749/files/spotted_small_ROI.RDS/content",
  expected_md5 = "454bfc51907b9a83e51144479a8cf98e"
)
spotted_small <- readRDS(spotted_small_file)
```
