...
```{r, fig.width=11, fig.height=5, warning=FALSE, message=FALSE, dpi = 150}
...
```{r, fig.width=20, fig.height=5, warning=FALSE, message=FALSE, dev.args = list(bg = "#ffffff"), dpi = 150}
